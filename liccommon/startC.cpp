...
int startC(int argc, char* argv [])
{
	...
	//if (!(ca_private_key = tetris::pki::load_private_key ("/home/geoeast/lg/NGC/chen/tetris/src/third/ca/cakey.pem"))) {
        if (!(ca_private_key = tetris::pki::load_private_key ("/home/cjh/tetris/tetris/src/third/ca/cakey.pem"))) {
	...
	||!generate_credential_data ("2:0:0:0", &server_cert, &server_key)
